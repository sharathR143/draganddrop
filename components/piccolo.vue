<template>
  <!-- <main
    class="bg-white mt-10 py-5 3xl:px-[10px] 3xl:mt-5 rounded-lg xl:w-[1200px] 1xl:w-[1280px] 2xl:w-[1460px] 3xl:w-[1830px] xl:ml-[-60px] 1xl:ml-[-100px] 2xl:ml-[40px] 3xl:ml-[-60px] 3xl:h-[900px]"
  >
    <div>
      <h1
    ...
    <div class="flex">
      <aside
        class="container pt-10 rounded-lg ml-5 1xl:h-[500px] 2xl:h-[550px] pb-10 1xl:w-[680px] 2xl:w-[800px] 3xl:w-[1000px] 3xl:h-[740px]"
        style="background-color: #eff2ef"
      >
        <div
          class="pr-2 mt-[0px] ml-4 bg-red-00 relative left-[-10px] top-[-30px] w-[100px] h-[30px]"
        >
          <div class="flex bg-red-00 w-[250px] justify-between">
            ...
            <div
              ...
              class="mr-2 mt-2 text-[20px] text-[#992121] font-bold"
            >
              Scenario Creator
            </div>
          </div>
        ...
        <header v-if="!showPiccoloScenario">
          <main class="bg-red-00 overflow-auto pt-5 h-[450px]">
            <div class="flex gap-2 flex-wrap ml-[30px] py-5 justify-start">
              <div
                v-for="card in cards"
                :key="card"
                class="bg-white ml-10 mb-10 rounded-lg relative"
                @click="selectCard(card)"
                @dblclick="deselectCard"
                :class="[
                  'bg-white border-2 ml-10 mb-10 rounded-lg relative cursor-pointer transition-colors duration-300',
              ...
              >
                <div
                  v-if="animationCard === card.name"
                  class="absolute top-[-50px] left-[110px] transform -translate-x-1/2 text-4xl text-red-500 arrow-animation"
                >
                  <svg
                ...
                <div class="bg-red-300 flex justify-center items-center">
                  <img
                    ...
                    alt="Car images"
                    class="absolute top-[10px] left-[15px] h-[150px] w-[270px] rounded-lg"
                  />
                </div>
                <div
                  class="bg-yellow-00 flex justify-end capitalize pt-[170px] mr-9"
                >
                  {{ card.name }}
                </div>

                <section
                  class="bg-red-00 min-h-[250px] mb-5 overflow-auto flex"
                >
                  <div class="flex justify-end items-end">
                    ...
                    >
                      <div
                        class="bg-gray-300 px-2 py-1 mb-1 mx-3 flex justify-center text-[16px] items-center"
                      ...
                      <div
                        class="bg-blue-300 px-5 py-1 mb-1 mx-3 flex justify-center items-center"
                      >
                        {{ system.system }}
                      </div>
                    </div>
  ...
  <main
    class="bg-white mt-10 py-5 3xl:px-[10px] 3xl:mt-5 rounded-lg xl:w-[1200px] 1xl:w-[1280px] 2xl:w-[1460px] 3xl:w-[1830px] xl:ml-[-60px] 1xl:ml-[-100px] 2xl:ml-[20px] 3xl:ml-[-60px] 3xl:h-[900px]"
  >
    <div>
      <h1
        class="font-bold uppercase mb-[10px] pl-5 text-[#992121] text-[20px] 1xl:text-[17px] 3xl:text-[23px]"
    ...
    <div class="flex">
      ...
      >
        <div
          class="pr-2 mt-0 ml-4 bg-red-00 relative left-[-10px] top-[-30px] w-[100px] h-[30px]"
        >
          <div class="flex bg-red-00 w-[250px] justify-between">
            <v-btn
              :icon="showPiccoloScenario ? 'mdi-close' : 'mdi-plus'"
          ...
          <main class="bg-red-00 overflow-auto pt-5 h-[450px]">
            <div class="flex gap-2 flex-wrap ml-[30px] py-5 justify-start">
              <div
                ...
                :class="[
                  'bg-white ml-10 mb-10 rounded-lg relative cursor-pointer transition-colors duration-300',
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <g clip-path="url(#__lottie_element_27881)">
                      <g
                        transform="matrix(3.19,0,0,3.19,424.1,338.81)"
                        opacity="1"
                        style="display: block"
                      >
                        <g opacity="1" transform="matrix(1,0,0,1,50.73,64.32)">
                          <path
                            fill="rgb(255,94,0)"
                            d="M46.055,5.84 C50.479,2.628 50.479,-2.629 46.055,-5.841 C46.055,-5.841 -44.6,-60.858 -44.6,-60.858 C-49.024,-64.071 -50.478,-61.874 -47.831,-55.977 C-47.831,-55.977 -16.658,0 -16.658,0 C-16.658,0 -47.831,55.977 -47.831,55.977 C-50.478,61.874 -49.024,64.071 -44.6,60.859 C-44.6,60.859 46.055,5.84 46.055,5.84z"
                          ></path>
                        </g>
                        <g
                          opacity="1"
                          transform="matrix(1,0,0,1,50.838,95.491)"
                        >
                          <path
                            fill="rgb(206,76,0)"
                            d="M-16.767,-31.169 C-16.767,-31.169 -47.941,24.808 -47.941,24.808 C-50.588,30.705 -49.134,32.902 -44.71,29.69 C-44.71,29.69 45.945,-25.329 45.945,-25.329 C48.157,-26.935 49.263,-29.052 49.263,-31.169 C49.263,-31.169 -16.767,-31.169 -16.767,-31.169z"
                          ></path>
                        </g>
                      </g>
                      <g
                        transform="matrix(3.19,0,0,3.19,264.098,338.813)"
                        opacity="1"
                        style="display: block"
                      >
                        <g opacity="1" transform="matrix(1,0,0,1,50.73,64.322)">
                          <path
                            fill="rgb(255,94,0)"
                            d="M46.055,5.84 C50.479,2.628 50.479,-2.629 46.055,-5.841 C46.055,-5.841 -44.6,-60.858 -44.6,-60.858 C-49.024,-64.071 -50.478,-61.874 -47.831,-55.977 C-47.831,-55.977 -16.658,0 -16.658,0 C-16.658,0 -47.831,55.977 -47.831,55.977 C-50.478,61.874 -49.024,64.071 -44.6,60.859 C-44.6,60.859 46.055,5.84 46.055,5.84z"
                          ></path>
                ...
                <!-- Card Image Section -->
                <div
                  class="bg-red-00 flex justify-center items-center relative h-[150px]"
                >
                  <img
                    v-if="getImageForCard(card.name)"
                    :src="getImageForCard(card.name)"
                    alt="Car images"
                    class="absolute top-[10px] left-[15px] h-[150px] w-[270px] rounded-lg object-cover"
                  />
                </div>

                <!-- Card Name Section -->
                <div
                  class="bg-yellow-00 flex justify-end capitalize pt-[10px] mr-9 text-lg font-semibold text-[#992121]"
                >
                  {{ card.name }}
                </div>
                ...
                >
                  <div class="flex justify-end items-end w-full">
                    ...
                    >
                      <div
                        class="bg-gray-300 px-2 py-1 mb-1 mx-3 flex justify-center text-[16px] items-center rounded"
                        v-for="containerName in system.containers"
                        :key="containerName"
                      >
                        {{ containerName }}
                      ...
                      <div
                        class="bg-blue-300 px-5 py-1 mb-1 mx-3 flex justify-center items-center rounded"
                      >
                        {{ system.system }}
                      </div>
                    </div>
...
let cards = ref([
  {
    ...
    components: [
      ...
      { system: "soc1", containers: ["rdv", "mavd", "frism", "blis"] },
...
const isSelected = (card) => selectedCard.value === card.name;

// Function to select a card (single click)
const selectCard = (card) => {
  // If clicking the same card again, do nothing or reset the animation
  if (selectedCard.value === card.name) {
    // Optionally, you can reset the animation
    resetAnimation(card.name);
    return;
  }
  ...
  // Start the animation
  startAnimation(card.name);
};

// Function to deselect a card (double click)
const deselectCard = () => {
  selectedCard.value = null;
  animationCard.value = null;
  clearAnimationTimer();
};

// Function to start the animation
const startAnimation = (cardName) => {
  // Clear any existing animation timer
  clearAnimationTimer();
  // Set the animationCard to the selected card
  animationCard.value = cardName;
