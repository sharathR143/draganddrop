    ...
    <aside  class="mr-5 xl:h-[250px] 1xl:h-[380px] 2xl:h-[400px] 3xl:h-[550px] 2xl:w-[520px] 3xl:w-[620px]  mx-10 rounded-lg  xl:mt-3 1xl:mt-3 2xl:mt-5" style="background-color:#FFFFFF">
      ...
      <div class="flex justify-evenly mr-5 xl:h-[250px] 1xl:h-[290px] 2xl:h-[380px]   mx-10 rounded-lg  xl:mt-3 1xl:mt-3 2xl:mt-5">
        <div class="flex gap-2 items-end  border-red-300 h-[300px]  3xl:h-[400px] mt-[15px]">
            ...
            <div v-if="selectedCardName== 'Eco mode ON for BMS'"  class="flex gap-2 items-end bg-red-00  3xl:w-[460px] ">
            <div class="bg-yellow-00  3xl:ml-[20px]   cursor-pointer">
              <div class="h-[270px]      2xl:overflow-auto  3xl:overscroll-none  bg-gray-00    bg-yellow-00">
                 <div class="flex gap- items-end justify-center px-[0px] h-[250px]  bg-gray-00  mb-5">
                  <div v-for="host in hostnames" :key="host">
                    ...
                    <div class="1xl:px-[10px]  capitalize 1xl:py-[5px] 2xl:px-[10px]  2xl:py-[7px] 3xl:px-[10px]  3xl:py-[10px]  3xl:w-[80px] mx-5  border-dashed border-blue-400  bg-gray-300 border-2 text-center" v-if="host ==='Zc front'|| host ==='Zc rear'" >
                       {{ host }}
                       </div>
          ...
          <div v-else-if="selectedCardName== 'Charging for BMS'"  class="flex gap-2 items-end bg-red-00  3xl:w-[460px] ">
...
<!-- 
          <div v-else  class=" flex  gap items-end 3xl:w-[380px] bg-yellow-200">
            <div v-for="host in hostnames" :key="host">
                  ...
                  <div class="bg-whit bg-red-200 mb-4 flex justify-end  items-end ">
                    <div class="1xl:px-[10px]  1xl:py-[5px] 2xl:px-[10px]  2xl:py-[7px] 3xl:px-[10px]  3xl:py-[10px]  3xl:w-[80px] mx-5 border-dashed border-blue-400   bg-gray-300 border-2 "   v-if="host ==='Zc front'|| host ==='Zc rear'">
                      <span class="capitalize  text-center">{{ host }}</span>
                    </div>
                    <span class=" 1xl:px-[10px] capitalize  1xl:py-[5px] 2xl:px-[10px]  2xl:py-[7px]  3xl:px-[10px] text-center 3xl:py-[10px]  3xl:w-[80px] mx-5 border-dashed border-blue-400 border-2 " v-else>
                      {{ host }}
                    </span>
                  </div>
                </div>
          </div> -->
          <div v-else  class="flex gap-2 items-end bg-red-00  3xl:w-[460px] ">
            <div class="bg-red-00 3xl:ml-[20px]   cursor-pointer">
              <div class="h-[270px]      2xl:overflow-auto  3xl:overscroll-none  bg-gray-00    bg-yellow-00">
                 <div class="flex gap- items-end justify-center px-[0px] h-[250px]  bg-gray-00  mb-5">
                  <div v-for="host in hostnames" :key="host">
