...
<div class="flex mb-2 ml-1 pt-2 3xl:pb-4" >
  ...
  <main class="bg-gray-200  1xl:h-[400px] 2xl:h-[500px]  rounded-lg" style="background-color:#EFF2EF;"> 
    ...
    <div class="cursor-pointer bg-red-00 1xl:h-[120px] 2xl:h-[140px]  3xl:h-[180px]" :class="{ 'py-2 px-2 border-4 border-red-500': selectedImage === 'driving' }" @click="selectImage('driving')">
    <img src="/public/img/car.png" alt="parking image" class="1xl:w-[120px] 1xl:h-[80px]  2xl:w-[150px] rounded-lg  2xl:h-[100px]  3xl:w-[200px] 3xl:h-[130px] "> 
      <div class="flex justify-center">
        <p>Driving</p>
      </div>
    </div>

    <div class="cursor-pointer  bg-red-00 1xl:h-[120px] 2xl:h-[140px]  3xl:h-[180px]" :class="{ 'py-2 px-2 border-4 border-red-500': selectedImage === 'parking' }" @click="selectImage('parking')">
    ...
    <div class="cursor-pointer  bg-red-00 1xl:h-[120px] 2xl:h-[140px]  3xl:h-[180px]" :class="{ 'py-2 px-2 border-4 border-red-500': selectedImage === 'charging' }" @click="selectImage('charging')">
    ...
    <div class="cursor-pointer  bg-red-00 1xl:h-[120px] 2xl:h-[140px]  3xl:h-[180px]" :class="{ 'py-2 px-2 border-4 border-red-500': selectedImage === 'lowbattery' }" @click="selectImage('lowbattery')">
    <img src="/public/img/lowbattery.png" alt="low battery image" class="1xl:w-[120px] 1xl:h-[80px]  2xl:w-[150px] rounded-lg  2xl:h-[100px]  3xl:w-[200px] 3xl:h-[130px]"> 
      <div class="flex justify-center">
        <p>Low Battery</p>
      </div>
    </div>
               ...
               <div class="flex justify-center items-center 2xl:mt-2 3xl:mt-[40px]">
                  <header v-for="(host, index) in hostnames" :key="index" class="mx-6 bg-green-00 overflow-auto ">
                      ...
                      <section class="bg-yellow-00   ">
                         <div class="1xl:px-3  1xl:py-1 2xl:px-6  2xl:py-2 border bg-blue-400 border-gray-500 text-center capitalize  text-black">
                          {{ host.system }}
                         </div>
                      </section>
                  </header>
...
const dragelement = ref([ "rdv", "camera", "location", "mavd", "frism", "DSM", "blis"]);
